let express,Tablas,jwt,User;_4d2‍.x([["tokensValidos",()=>tokensValidos],["default",()=>_4d2‍.o]]);_4d2‍.w("express",[["default",["express"],function(v){express=v}]]);_4d2‍.w("../models/Tablas.js",[["default",["Tablas"],function(v){Tablas=v}]]);_4d2‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_4d2‍.w("../models/user.js",[["default",["User"],function(v){User=v}]]);//aqui van las rutas de todo lo relacionado a tabla
...
router.get("/eventos/crear", async (req,res) =>{
    ...
    try {
        ...
        _4d2‍.g.console.log('Token válido:', decoded);
        ...
        _4d2‍.g.console.error('Error:', error);
