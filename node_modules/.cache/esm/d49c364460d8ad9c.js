let express,User,jwt,tokensValidos,verificarToken;_60d‍.x([["default",()=>_60d‍.o]]);_60d‍.w("express",[["default",["express"],function(v){express=v}]]);_60d‍.w("../models/user.js",[["default",["User"],function(v){User=v}]]);_60d‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_60d‍.w("./tablas.js",[["tokensValidos",["tokensValidos"],function(v){tokensValidos=v}],["verificarToken",["verificarToken"],function(v){verificarToken=v}]]);
...
router.get("/usuarios/corriente", async (req, res) => {
    ...
    try {
        ...
        _60d‍.g.console.log("currentUser", currentUser);
        res.render("Usuarios/register", { user: { name: current.name } });
    } catch (error) {
        _60d‍.g.console.error('Error:', error);
        res.json({ success: false, message: "acceso denegado" });
    }
});
...
router.post("/usuarios/crear" , async (req, res) => {
    _60d‍.g.console.log("data", req.body);
